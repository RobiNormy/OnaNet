// Provider registration coverage-area step.
import 'dart:async';
...
import 'package:ona_net/features/provider_registration/presentation/contact_details_screen.dart';
import 'package:ona_net/features/provider_registration/presentation/widgets/provider_flow_widgets.dart';
...
class _CoverageAreasScreenState extends State<CoverageAreasScreen> {
  ...
  void _saveCoverageArea() {
    if (_savedCoverageAreas.length >= _freeCoverageAreaLimit) {
