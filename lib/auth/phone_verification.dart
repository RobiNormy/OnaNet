...
class PhoneVerificationService {
  ...
  Future<OtpStartResult> startVerification({
  ...
  String _errorMessage(DioException error){
    ...
    ? (error.response!.data['detail']?.toString()) : null;
...
class OtpStatusResult {
  OtpStatusResult({
    required this.phoneNumber, required this.isVerified
});
